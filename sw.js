...
// T-024 adds only the opt-in Natural Beta shell module. The stable neural/runtime cache
// remains untouched; Supertonic assets are read from sibling FIEZEL-APPS and are not
// duplicated into the CLONE shell cache.
const SW_REV='m025-32-indonesian-natural-beta-20260819-1';
const SHELL_CACHE=`fiezel-clone-shell-${SW_REV}`;
const ASSETS=['./','./index.html','./style.css','./version.js','./clone-build.js','./report-config.js','./core-config.js','./content-canary.js','./content-promotion.js','./content-canary-config.js','./lucide.min.js','./app.js','./validator.js','./manifest.json','./vocabulary-master.json','./reading-bank.json','./grammar-templates.json','./favicon-64.png','./apple-touch-icon.png','./instagram.svg','./creator-report-setup.html','./creator-report-dashboard.html','./fiezel-report-worker.js','./features/neural-voice/fiezel-neural-voice-config.js','./features/neural-voice/fiezel-kokoro-adapter.js','./features/neural-voice/fiezel-sherpa-vits-adapter.js','./features/neural-voice/fiezel-neural-voice.js','./features/neural-voice/fiezel-web-audio-player.js','./features/neural-voice/fiezel-neural-voice-bootstrap.js','./features/neural-voice/fiezel-neural-voice-ios-cache-fix.js','./features/neural-voice/fiezel-neural-voice-cache-integrity-repair.js','./features/neural-voice/fiezel-neural-voice-audibility-fix.js','./features/neural-voice/fiezel-indonesian-voice-bridge.js','./features/neural-voice/fiezel-indonesian-human-prosody-lab.js','./features/neural-voice/fiezel-diag-panel.js','./features/neural-voice/fiezel-pipeline-device-probe.js','./features/speaking-listening/speaking-listening-config.js','./features/speaking-listening/fiezel-speaking-listening-addon.js','./features/speaking-listening/speaking-listening-addon.css','./features/speaking-listening/listening-bank-v1.json','./features/speaking-listening/speaking-bank-v1.json','./features/classroom/fiezel-classroom.js','./features/classroom/classroom-lessons-v1.json','./features/spatial-dock/spatial-dock.css','./features/spatial-dock/spatial-dock.js','./features/spatial-dock/spatial-dock-hotfix.css','./features/spatial-dock/spatial-dock-hotfix.js'];
// Neural runtimes are owned by the explicit prepare layer. The optional Indonesian
// bundle is cached under local /vendor/sherpa-vits-id/ URLs and must survive shell
// releases exactly like the mandatory English Sherpa/Kokoro assets.
const isNeuralAsset=request=>{const p=new URL(request.url).pathname;return p.includes('/vendor/kokoro-')||p.includes('/vendor/sherpa-vits/')||p.includes('/vendor/sherpa-vits-id/')};
