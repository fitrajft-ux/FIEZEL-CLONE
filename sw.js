...
const SW_REV='m025-31-apps-m02548-parity-natural-beta-20260819-1';
const SHELL_CACHE=`fiezel-clone-shell-${SW_REV}`;
const ASSETS=['./', './index.html', './style.css', './version.js', './clone-build.js', './report-config.js', './core-config.js', './content-canary.js', './content-promotion.js', './content-canary-config.js', './lucide.min.js', './app.js', './validator.js', './manifest.json', './vocabulary-master.json', './reading-bank.json', './grammar-templates.json', './favicon-64.png', './apple-touch-icon.png', './instagram.svg', './creator-report-setup.html', './creator-report-dashboard.html', './fiezel-report-worker.js', './features/diagnostics/fiezel-diagnostic-targets.js', './features/diagnostics/fiezel-diagnostic-bus.js', './features/diagnostics/fiezel-module-selftests.js', './features/diagnostics/fiezel-diagnostic-register.js', './features/classroom/fiezel-classroom.js', './features/classroom/classroom-lessons-v1.json', './features/tutor-classroom/fiezel-tutor-v3.js', './features/tutor-classroom/tutor-v3.css', './features/speaking-listening/speaking-listening-config.js', './features/speaking-listening/fiezel-speaking-listening-addon.js', './features/speaking-listening/speaking-listening-addon.css', './features/speaking-listening/listening-bank-v1.json', './features/speaking-listening/speaking-bank-v1.json', './features/ui/fiezel-zoom-lock.js', './features/audio/fiezel-soundtrack.js', './features/daily-target/fiezel-daily-target.js', './features/tutor-classroom/fiezel-tutor-dialog.js', './features/tutor-classroom/fiezel-tutor-voice-chat.js', './features/library/fiezel-library.js', './features/library/fiezel-library-ui.js', './features/library/library-books-v1.json', './features/neural-voice/fiezel-neural-voice-config.js', './features/neural-voice/fiezel-kokoro-adapter.js', './features/neural-voice/fiezel-sherpa-vits-adapter.js', './features/neural-voice/fiezel-neural-voice.js', './features/neural-voice/fiezel-web-audio-player.js', './features/neural-voice/fiezel-neural-voice-bootstrap.js', './features/neural-voice/fiezel-neural-voice-ios-cache-fix.js', './features/neural-voice/fiezel-neural-voice-cache-integrity-repair.js', './features/neural-voice/fiezel-neural-voice-audibility-fix.js', './features/neural-voice/fiezel-diag-panel.js', './features/neural-voice/fiezel-pipeline-device-probe.js', './features/neural-voice/fiezel-indonesian-human-prosody-lab.js'];
